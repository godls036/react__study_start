...
// -> (setState/props 바뀔때 -> render -> componentDidUpadte)
...
class RSP extends Component {
    ...
    render() {
        return (
            <>
                <div id="computer" style={{ background: `url(http://en.pimg.jp/023/182/267/1/23182267.jpg) ${this.state.imgCoord} 0` }}></div>
                <div>
